...
# data_sources_build/cgs.do and queries the OpenFIGI API in order to retrieve the FIGI identifiers 
...
final_df_cusip.rename(columns={'idValue': 'cusip'}).to_stata("raw/figi/figi_master.dta")
