* --------------------------------------------------------------------------------------------------
* Orbis_Build: This file build the ultimate-parent aggregation data from Bureau van Dijk, which is
* used as input in the CMNS aggregation procedure.
* --------------------------------------------------------------------------------------------------
cap log close
log using "$logs/${whoami}_Orbis_Build", replace
...
save "$aggregation_sources/orbis_aggregation.dta", replace
